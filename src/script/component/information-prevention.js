...
class InformationPrevention extends HTMLElement {
    ...
    render() {
        ...
        <div class="left-container">
            <img src="${this.dataInformation[0].image}"></img>
        </div>
        <div class="right-container">
           ${this.dataInformation[0].description}
        </div>
    </div>
    
    <div class="step-prevention">
        <div class="right-container">
        ${this.dataInformation[1].description}
        </div>
        <div class="left-container">
            <img src="${this.dataInformation[1].image}">
        </div>
    ...
    <div class="step-prevention">
        <div class="left-container">
            <img src="${this.dataInformation[2].image}">
        </div>
        <div class="right-container">
            ${this.dataInformation[2].description}
        </div>
    </div>`
    }
}
